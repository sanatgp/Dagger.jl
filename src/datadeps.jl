#=
Complete Data Dependency and Load Balancing System for DaggerFFT
...
import Dagger: short_name, current_acceleration, default_processor
import Dagger: check_uniform, with_options, wait_all, spawn_bulk
import Dagger.Sch
